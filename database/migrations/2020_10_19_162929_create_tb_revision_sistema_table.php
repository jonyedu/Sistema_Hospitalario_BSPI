    ...
    public function up()
    {
        if (!Schema::connection('control_hospitalario_db_sql')->hasTable('tb_revision_sistema')) {
            Schema::connection('control_hospitalario_db_sql')->create('tb_revision_sistema', function (Blueprint $table) {
                ...
                $table->string('otrosCardiovascularValor')->nullable();
                ...
                $table->string('otrosRespiratorioValor')->nullable();
                ...
                $table->string('otrosNeurologicoValor')->nullable();
                ...
                $table->string('otrosNefrologicosValor')->nullable();
                ...
                $table->string('otrosGastrointestinalValor')->nullable();
                ...
                $table->string('otrosSistemaEndocrimaValor')->nullable();
