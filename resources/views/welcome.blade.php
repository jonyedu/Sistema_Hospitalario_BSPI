                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <img src=" {{url('logosbspipng/hospital.png')}} " borde="0" width="50px" height="50px" />
                                <div  class="ml-4 text-lg leading-7 font-semibold">
                                    <a  href="{{ route('login') }}" class="underline text-gray-900 dark:text-white">
                                        Sistema Hospitalario Integrado</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                <img src=" {{url('logosbspipng/estadisticas.png')}} " borde="0" width="50px" height="50px" />
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Business Intelligence</div>
                            </div>
