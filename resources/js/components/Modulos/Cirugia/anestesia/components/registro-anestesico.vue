<template>
  <div>
    ...
    <div class="flex flex-center-x mt-2 mb-2">
      <button class="btn btn-success" v-if="!iniciado" v-on:click="start_time">Iniciar</button>
      <button class="btn btn-danger" v-if="iniciado" v-on:click="end_time">Finalizar</button>
    </div>
    <div class="" style="width: 90%; margin: 0 auto">
      <div class="row flex-center-x">
        <p class="badge badge-warning pl-3 pr-3 pt-2 pb-2" style="font-size: 1.0em">
      ...
      <div class="row mb-5" v-if="iniciado">
        ...
        <div class="col-md-4 border-t pt-2 pb-4">
          <div class="text-center"><p class="text-center">RESPIACIÓN</p></div>
          <div class="row flex flex-center-x">
              <div class="col-lg-4 col-md-5 flex flex-x flex-center-y">
                <label for="respiracion_esp" class="mr-2">ESP</label>
                <input
                  ...
                  id="respiracion_esp"
                  value="ESP"
                  v-model="valoresFormulario.respiracion.descripcion"
                />
              </div>
              <div class="col-lg-4 col-md-5 flex flex-x flex-center-x flex-center-y">
                <label for="respiracion_asis" class="mr-2">ASIS</label>
                <input
                  class="input-registro"
                  type="radio"
              ...
              <div class="col-lg-4 col-md-5 flex flex-x flex-center-x flex-center-y">
                <label for="respiracion_cont" class="mr-2">CONT</label>
                <input
                  class="input-registro"
                  type="radio"
          ...
          <div class="row">
            <div class="col-md-12 flex flex-center-x pt-2 pb-4">
              <div class="row">
                <label for="ta_value" class="mr-2 col-12">Valor</label>
                <input
                  class="input-registro col-12 text-center"
                  type="text"
                  name="ta_value"
                  id="ta_value"
                  v-model="valoresFormulario.respiracion.valor"
                />
              </div>
            </div>
          </div>
        ...
        >
          <label for="valor_temperatura" class="mr-2">TEMPERATURA</label>
          <input
            class="input-registro text-center"
            type="text"
        ...
        <div
          class="col-md-3 flex border-t flex-y flex-center-x flex-center-y pt-2 pb-4"
        >
          <label for="valor_pres_venosa" class="mr-2">PRES VENOSA</label>
          <input
            class="input-registro text-center"
            type="text"
        ...
        <div
          class="col-md-3 flex border-t flex-y flex-center-x flex-center-y pt-2 pb-4"
        >
          <label for="valor_torniquete" class="mr-2">TORNIQUETE</label>
          <input
            class="input-registro text-center"
            type="text"
        ...
        <div class="col-md-3 border-t pt-2 pb-4">
          ...
          <div class="row flex flex-center-x">
            <div
              ...
              :key="index"
            >
              <label :for = "'radio-posicion-'+posicion.id" class="mr-2 grid-center">{{ posicion.descripcion }}</label>
        ...
        <div class="flex felx-center mt-2 mb-2" style="margin: 0 auto">
          <button class="btn btn-primary" v-on:click="obtenerDatosFormulario">Agregar</button>
        </div>
      </div>
      ...
      <div v-if="iniciado">
          ...
          <div class="col-12">
            <div class="row">
              <div class="col-lg-3 col-md-4 col-4">
                <div class="border-b row" style="background: transparent">
                  AGENTE/HORA
                </div>
                <div class="row he25 border-b border-r" v-for="(text, index) of agentes_text" :key="index">
                  <input type="text" name="" id="" v-model="agentes_text[index].descripcion" style="width:100%">
                </div>
                <!-- Agente hora -->
                <div class="row">
                  <div class="col-8" id="tabla-datos-grafica">
                    <div
                      class="row mt-2 mb-2"
                      v-for="(item, index) of tabla_datos_grafica"
                      :key="index"
                    >
                      <!-- {{item}} -->
                      <div class="col-9">{{ item.descripcion }}</div>
                      <div class="col-3">
                        <img
                          v-if="item.img_url"
                          width="15"
                  ...
                  <div class="col-2 p-0">
                    <div style="margin-top: 5.4rem">
                      <p style="margin-bottom:2.1rem" v-for="(item, index) of datos_grados" :key="index">
                        {{ item }}&deg;
                      </p>
                    </div>
                  </div>
                  <div class="col-2 p-0">
                    <div
                      v-for="(item, index) of valoresAnestecia_v"
                      style="height: 1.80em"
                      :key="index"
                    >
                      {{ item.inicio }}
                ...
                <div class="row border-r flex-x-end" style="padding: 15px 5px">
                  <span>POSICION</span>
                </div>
              </div>
              <!-- DATOS  -->
              <div class="col-lg-9 col-md-8 col-8 overflow-x-hidden p-0">
                <div
                ...
                <!-- Cada hora -->
                  <div
                    v-for="(item, index) of lista_horas_avanzadas_v"
                  ...
                  >
                    ...
                    <!-- Cada fila de la hora -->
                      <div
                        v-for="(dato, index_fila) of item.datos"
                        :style="dato.styles"
                        :key="index_fila"
                      >
                        <div :style="dato.style" :class="dato._class">
                          <template v-if="dato.es_tiempo">
                            <div
                              ...
                              :key="index_columna"
                            >
                              <div class="p-0 flex space-btw relative">
                                <span v-if="columna.tiempo_inicio">
                                  {{ columna.tiempo_inicio }}</span
                                >
                                <span v-if="!columna.tiempo_inicio"
                                  ><img
                          ...
                          <template v-if="dato.es_dato">
                            <div
                              ...
                              :key="index_columna"
                            >
                              <div v-if="dato.es_dato">
                                <!-- {{ index_fila | json }} -->
                                <input type="text" style="width: 100%" v-model="agentes_text[index_fila-1].valores[index_columna]"/>
                              </div>
                            </div>
                          </template>
                          <template v-if="dato.es_agente">
                            <div
                              style="
                                height: 1.82em;
                            ...
                            >
                              ...
                              >
                                <!-- {{minutos_columna}} -->
                                <template v-if="minutos_columna.agentes">
                                  <img
                                    v-for="(agente,
                          ...
                          <template v-if="dato.es_posicion">
                            <div
                              style="
                                height: 50px;
                                grid-template-columns: 1fr 1fr 1fr;
                            ...
                            >
                              ...
                              <img
                                v-if="columna.posicion.id != 0"
                                class="ml-3"
                                :src="'/'+columna.posicion.img_url"
                                alt=""
                                style="width: 70px"
                              />
                              <!-- </div> -->
        ...
        -->
        <div class="row border-t">
          <div class="col-lg-9 col-md-12 border-t mt-3" style="border-top: 1px solid #000">
            <div class="row">
              <div class="col-md-12 border-b border-r text-center">
                DROGAS ADMINISTRADAS
              </div>
              <div class="col-md-4">
                <div class="row border-b">
                  <div class="col-md-2 border-r pl-0 text-center">N°</div>
                ...
                <div class="row">
                  <div class="col-md-2 border-r pl-0 text-center">1</div>
                ...
                <div class="row">
                  <div class="col-md-2 border-r pl-0 text-center">2</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
                ...
                <div class="row">
                  <div class="col-md-2 border-r pl-0 text-center">3</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
              ...
              <div class="col-md-4">
                <div class="row border-b">
                  <div class="col-md-2 border-r pl-0 text-center">4</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
                ...
                <div class="row">
                  <div class="col-md-2 border-r pl-0 text-center">5</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
                ...
                <div class="row">
                  <div class="col-md-2 border-r pl-0 text-center">6</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
                ...
                <div class="row">
                  <div class="col-md-2 border-r pl-0 text-center">7</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
              ...
              <div class="col-md-4">
                <div class="row border-b">
                  <div class="col-md-2 border-r pl-0 text-center">8</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
                ...
                <div class="row">
                  <div class="col-md-2 border-r pl-0 text-center">9</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
                ...
                <div class="row">
                  <div class="col-md-2 border-r pl-0 text-center">10</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
                ...
                <div class="row">
                  <div class="col-md-2 border-r pl-0 text-center">11</div>
                  <div class="col-md-10 border-r p-0">
                    <input
                      type="text"
                      class="input-line"
          ...
          <!-- TIEMPOS -->
          <div class="col-md-12 col-lg-3 border-t mt-3"  style="border-top: 1px solid #000">
            <div class="row border-b flex flex-center-x">TIEMPOS</div>
            <div class="row">
              <div class="col-md-2">
                <input
                  type="text"
              ...
              <div class="col-md-10 border-r">DURACIÓN ANESTESIA</div>
            </div>
            <div class="row">
              <div class="col-md-2">
                <input type="text" class="m-w input-line" name="hs_min" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-10 border-r">DURACIÓN OPERACIÓN</div>
            </div>
            <div class="row border-b">
              <div class="col-md-2">
                <input type="text" class="input-line m-w" name="h_min" />
              </div>
            ...
            <div class="row border-b">
              ...
              <div class="col-md-6">
                <div class="row border-b border-r">
                  <label class="col-md-11 p-0 m-0" for="general"
                    ><span class="space-left">GENERAL</span></label
                  >
                ...
                <div class="row border-r">
                  <label class="col-md-11 p-0 m-0 upper" for="sistema-abierto"
                    ><span class="space-left">sistema abierto</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input
                      type="checkbox"
                ...
                <div class="row border-r">
                  <label class="col-md-11 p-0 m-0 upper" for="sistema-cerrado"
                    ><span class="space-left">sistema cerrado</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input
                      type="checkbox"
                ...
                <div class="row border-r">
                  <label class="col-md-11 p-0 m-0 upper" for="sistem-semi-cerr"
                    ><span class="space-left">sistem semi-cerr</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input
                      type="checkbox"
                ...
                <div class="row border-r">
                  <label class="col-md-12 p-0 m-0 upper" for=""
                    ><span class="space-left">apartos usados</span></label
                  >
                  <div class="col-md-12s p-0">
                    <label for="cinc" class="upper"
                      ><span class="space-left">cinc</span></label
                    >
                    <input type="checkbox" name="cinc" id="cinc" />
                    <label for="vaiiven" class="upper ml-2">vaiiven</label>
                    <input type="checkbox" name="vaiiven" id="vaiiven" />
                  </div>
                </div>

                <div class="row border-b border-r">
                  <label class="col-md-11 p-0 m-0 upper" for="mascara"
                    ><span class="space-left">mascara</span></label
                  >
                  <div class="col-md-1 p-0">
                ...
                <div class="row flex border-r">
                  <span class="col-md-12 p-0 m-0 upper text-center"
                    >inte. traqueal</span
                  >
                </div>
                ...
                <div class="row border-r">
                  <div class="col-md-12 p-0">
                    <label for="oral" class="upper"
                      ><span class="space-left">oral</span></label
                    >
                    <input type="checkbox" name="oral" id="oral" />
                    <label for="nasal" class="upper ml-2">nasal</label>
                    <input type="checkbox" name="nasal" id="nasal" />
                  </div>
                  <div class="col-md-12 p-0">
                    <label for="rapido" class="upper"
                      ><span class="space-left">rapido</span></label
                    >
                    <input type="checkbox" name="rapido" id="rapido" />
                    <label for="lenta" class="upper ml-2">lenta</label>
                    <input type="checkbox" name="lenta" id="lenta" />
                  </div>
                </div>
                <div class="row flex border-r">
                  <span class="col-md-12 p-0 m-0"
                    ><span class="space-left">TURBO No________</span></span
                  >
                </div>
                <div class="row border-r">
                  <label class="col-md-11 p-0 m-0 upper" for="manguito-inflam"
                    ><span class="space-left">manguito inflam.</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input
                      type="checkbox"
                ...
                <div class="row border-r">
                  <label class="col-md-11 p-0 m-0 upper" for="Taponamiento"
                    ><span class="space-left">Taponamiento</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input
                      type="checkbox"
                ...
                <div class="row border-r">
                  <label class="col-md-11 p-0 m-0 upper" for="asist-topica"
                    ><span class="space-left">asist topica</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input
                      type="checkbox"
                ...
                <div class="row border-r">
                  <label class="col-md-11 p-0 m-0 upper" for="asist-tramboral"
                    ><span class="space-left">asist tramboral</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input
                      type="checkbox"
              ...
              <div class="col-md-6">
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0" for=""
                    ><span class="space-left">CONDUCTIVA</span></label
                  >
                </div>
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0 upper" for=""
                    ><span class="space-left">asepsia de piel</span></label
                  >
                </div>
                <div class="row border-b">
                  <span class="col-md-12 p-0 m-0"
                    ><span class="space-left">CON:___________</span></span
                  >
                </div>
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0 upper" for="habon"
                    ><span class="space-left">habon</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input type="checkbox" name="habon" id="habon" />
                  </div>
                </div>
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0 upper" for="raquidea"
                    ><span class="space-left">raquidea</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input type="checkbox" name="raquidea" id="raquidea" />
                  </div>
                </div>
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0 upper" for="epidural-caud"
                    ><span class="space-left">epidural caud</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input
                      type="checkbox"
                ...
                <div class="row">
                  <label class="col-md-11 p-0 m-0 upper" for="simple"
                    ><span class="space-left">simple</span></label
                  >
                  <div class="col-md-1 p-0">
                ...
                <div class="row">
                  <label class="col-md-11 p-0 m-0 upper" for="continua"
                    ><span class="space-left">continua</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input type="checkbox" name="continua" id="continua" />
                  </div>
                </div>
                <div class="row border-b flex text-center">
                  <label class="col-md-12 p-0 m-0" for="" style="font-size: 0.9em"
                    ><span class="space-left">ALTURA PUNCION</span></label
                  >
                </div>
                <div class="row">
                  <label class="col-md-11 p-0 m-0 upper" for="puncion-lat"
                    ><span class="space-left">puncion lat</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input type="checkbox" name="puncion-lat" id="puncion-lat" />
                  </div>
                </div>
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0 upper" for="linea-media"
                    ><span class="space-left">linea media</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input type="checkbox" name="linea-media" id="linea-media" />
                  </div>
                </div>
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0" for=""
                    ><span class="space-left">AGUJA No</span></label
                  >
                </div>
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0 upper" for=""
                    ><span class="space-left">nivel</span></label
                  >
                </div>
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0 upper" for="hiperbara"
                    ><span class="space-left">hiperbara</span></label
                  >
                  <div class="col-md-1 p-0">
                    <input type="checkbox" name="hiperbara" id="hiperbara" />
                  </div>
                </div>
                <div class="row border-b">
                  <label class="col-md-11 p-0 m-0" for=""
                    ><span class="space-left">POSICION PACIENTE</span></label
                  >
                </div>
              </div>
            </div>
          ...
          <div class="col-md-5 col-lg-5 border-t border-t mt-3">
            ...
            <div class="row border-b border-r">
              ...
              <label class="col-md-6 p-0 m-0 upper" for="dextrosas"
                ><span class="space-left">dextrosas</span></label
              >
            ...
            <div class="row border-b border-r">
              ...
              <label class="col-md-6 p-0 m-0 upper" for="expansiones"
                ><span class="space-left">EXPANSIONES</span></label
              >
              <div class="col-md-3 p-0">
                <input
                  class="input-line"
            ...
            <div class="row border-b border-r">
              ...
              <label class="col-md-3 p-0 m-0" for="">cc APROX</label>
            </div>
            <div class="row border-b flex flex-center-x"><span>apagar</span></div>
            <div class="row border-b border-r">
              <label class="col-md-3 p-0 m-0 upper" for="1-min">1 min</label>
              <label class="col-md-3 p-0 m-0 upper" for="5-min">5 min</label>
              <label class="col-md-3 p-0 m-0 upper" for="10-min">10 min</label>
            ...
            <div class="row">
              <label class="col-md-2" for="conducido_por">POR: </label>
              <input
                type="text"
                ...
                id="conducido_por"
              />
              <label class="col-md-2" for="conducido_hora">HORA: </label>
              <input
                type="text"
                class="input-line col-md-4"
                name="conducido_hora"
          ...
          <div class="col-lg-12 col-md-5 b-0 mt-3">
            ...
            <div class="row border-b pt-2 pb-2">
              <label class="col-md-5 p-0 m-0" for="hipotension"
                ><span class="space-left">HIPOTENSION</span></label
              >
              <div class="col-md-1 p-0">
                <input type="checkbox" name="hipotension" id="hipotension" />
              </div>
              <label class="col-md-5 p-0 upper m-0" for="arritmias"
                ><span class="">arritmias</span></label
              >
              <div class="col-md-1 p-0">
                <input type="checkbox" name="arritmias" id="arritmias" />
              </div>
            </div>
            <div class="row border-b pt-2 pb-2">
              <label class="col-md-5 p-0 upper m-0" for="depresion-respiratoria"
                ><span class="space-left">depresion respiratoria</span></label
              >
              <div class="col-md-1 p-0">
                <input
                  type="checkbox"
              ...
              <label class="col-md-5 p-0 upper m-0" for="perforacion-duramadre"
            ...
            <div class="row border-b pt-2 pb-2">
              <label class="col-md-5 p-0 upper m-0" for="dificultad-intubacion"
                ><span class="space-left">dificultad intubacion</span></label
              >
              <div class="col-md-1 p-0">
                <input
                  type="checkbox"
              ...
              <label class="col-md-5 p-0 upper m-0" for="nauseas-vomitos"
            ...
            <div class="row border-b pt-2 pb-2">
              <label class="col-md-5 p-0 upper m-0" for="conductiva-insuficiente"
                ><span class="space-left">conductiva insuficiente</span></label
              >
              <div class="col-md-1 p-0">
                <input
                  type="checkbox"
              ...
              <label class="col-md-5 p-0 upper m-0" for="laringo-espasmo"
            ...
            <div class="row border-b pt-2 pb-2">
              <label class="col-md-5 p-0 upper m-0" for="paro-cardiaco"
                ><span class="space-left">paro cardiaco</span></label
              >
              <div class="col-md-1 p-0">
                <input type="checkbox" name="paro-cardiaco" id="paro-cardiaco" />
              </div>
              <label class="col-md-5 p-0 upper m-0" for="ninguna">ninguna</label>
              <div class="col-md-1 p-0">
                <input type="checkbox" name="ninguna" id="ninguna" />
              </div>
            </div>
            <div class="row border-b pt-2 pb-2">
              <label class="col-md-5 p-0 upper m-0" for="cambio-tecnica"
                ><span class="space-left">cambio de tecnica</span></label
              >
              <div class="col-md-1 p-0">
                <input
                  type="checkbox"
            ...
            <div class="row border-b pt-2 pb-2">
              <div class="flex col-md-5 p-0 upper">
                ...
                <input class="border-none-b- w-100p" type="text" />
              </div>
            </div>
            <div class="row">
              <span class="col-md-12">COMENTATIOS:</span>
              <textarea name="" id="" class="col-md-12" rows="3"></textarea>
            </div>
            <div class="">
...
export default {
  data: function () {
    return {
      ...
      agentes_text : [{descripcion:'',valores: []},{descripcion:'',valores: []},{descripcion:'',valores: []},{descripcion:'',valores: []}],
  ...
  methods: {
    ...
    enviarDatosAgente(datos = {}, tipo){
      let url = "/modulos/cirugia/anestesia/agentes/guardado/"+this.registro_id;
      axios
      .post(url, {datos:datos, tipo: tipo, SecCirPro: cirugia_id})
      .then(response =>{
        console.log(response.data);
    ...
    start_time: function (event) {
      ...
      this.agregaDatoEnRejilla(true, false, 250, "img/icons/induccion.png", {system_name : 'INDUCCION' , tipo : this.system_agente});
    },
    /**
    ...
    end_time: function () {
      ...
      this.agregaDatoEnRejilla(true, false, 0,"img/icons/fin_anestecia.png",  {system_name : 'FIN-ANESTECIA' , tipo : this.system_agente});
    },
    /**
     ...
     * @param posicion
     */
    agregaDatoEnRejilla: function ( is_tpo_init, is_tpo_fin , valor, ruta_icono, adicional = {system_name : ''}, fila_indice = 0, es_posicion = false,posicion = {}) {
      // if(posicion)debugger
      var indice_fila =
        fila_indice != 0 ? fila_indice : this.obtenerIndice(valor);

      // Verifica el índice según la hora
      for (const column_quince of this.lista_horas_avanzadas_v[this.indice_hora]
    ...
    agregarDatos: function (campo) {
      // console.log(campo);
      this.agregaDatoEnRejilla(false, false, campo.valor, campo.ruta_img, {system_name : campo.descripcion, tipo: this.system_agente});
    },
    /**
     *
     */
    obtenerDatosFormulario: function () {
      ...
      let post_text = this.posiciones.find(e=> e.id == this.valoresFormulario.posicion.id);
      this.agregaDatoEnRejilla(
        false, false, 0, "", {system_name: post_text ? post_text.name_system : '', tipo : this.system_posicion}, this.lista_horas_avanzadas_v[this.indice_hora].datos.length - 2 - this.index_points, true,
    ...
    agregarDatoRespiracion(){
      this.valoresFormulario.respiracion.img_url = this.valoresFormulario.respiracion.descripcion == 'ESP' ?  'img/icons/esp.png': ( this.valoresFormulario.respiracion.descripcion == 'ASIS' ?  'img/icons/asis.png' : (this.valoresFormulario.respiracion.descripcion == 'CONT' ?  'img/icons/cont.png' : ''))
      // Agregar posicón en la rejilla
      this.agregaDatoEnRejilla(
        false, false, 0,
        this.valoresFormulario.respiracion.img_url,
        {system_name : this.valoresFormulario.respiracion.descripcion, tipo : this.system_respiracion},
    ...
    agregarDatoEnColumna(
      ...
      if (es_agente) {
        tiempo_acum = inicio;
        columnas.push(
          this.columnaCincoMin(tiempo_acum, tiempo_acum + 5, false, true)
        );
        tiempo_acum += 5;
        columnas.push(
          this.columnaCincoMin(tiempo_acum, tiempo_acum + 5, false, true)
